...
Scorecards com a média de cada indicador de satisfação
Gráfico de barras com avaliação por segmento de cliente
Pizza com distribuição dos segmentos

### Página 2 — Detalhamento

Tabela completa com segmento, tempo como cliente e notas individuais por respondente
